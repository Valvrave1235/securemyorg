...
<header>
                ...
                <header className=" fixed w-full max-w-screen-lg top-0 overflow-hidden h-24 flex md:hidden items-center justify-between px-4 z-50">
                    ...
                    <Link to="/contact-us" className="bg-transparent text-white py-2 px-4 rounded-full  flex  gap-2 border-2 font-semibold hover:bg-green-700 transition duration-300 ease-in-out items-center justify-center border border-green-600 w-fit ">
                        <span>Talk to Us </span>
                        <Arrow className="h-8" />
                    </Link>
                </header>
    
                <header className="bg-transparent absolute top-0 w-full max-w-screen-lg top-4  overflow-hidden py-4 px-2 rounded-xl  md:flex items-center justify-between px-4 z-50 hidden">
                    {/* Logo and Title */}
                    <div className="flex items-center opacity-100">
                        <StaticImage src="../images/logo.png" alt="SecureMyOrg Logo" className="" />
                        {/* <Logo className="h-12" /> */}
                        {/* <span className="text-white font-bold ml-2">SecureMyOrg</span> */}
                    </div>
